 ...
 * Created test customers and transactions for demonstration purposes.
 */
@Component
...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        Customer customer1 = new Customer(null, "Jessica");
        Customer customer2 = new Customer(null, "Alice");
        Customer customer3 = new Customer(null, "Willow");
