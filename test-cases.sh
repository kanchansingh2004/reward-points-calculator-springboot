...
curl -X POST http://localhost:8080/api/transactions \
  ...
  -d '{"customerId":1,"amount":120.00,"transactionDate":"2024-12-20"}'
echo ""
echo ""
...
curl -X POST http://localhost:8080/api/transactions \
  -H "Content-Type: application/json" \
  -d '{"customerId":1,"amount":75.00,"transactionDate":"2024-12-21"}'
echo ""
echo ""
...
curl -X POST http://localhost:8080/api/transactions \
  -H "Content-Type: application/json" \
  -d '{"customerId":1,"amount":200.00,"transactionDate":"2024-12-22"}'
echo ""
echo ""
...
curl -X POST http://localhost:8080/api/transactions \
  -H "Content-Type: application/json" \
  -d '{"customerId":1,"amount":45.00,"transactionDate":"2024-12-23"}'
echo ""
echo ""
